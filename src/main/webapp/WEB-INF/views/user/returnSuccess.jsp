...
<h1 class="blue"><i class="fa fa-check"></i></h1>
   <h1 class="title">우산 반납이 완료되었습니다 </h1>
   <p style="margin-top:20px;">우산 빌리지를 이용해주셔서 감사합니다😊</p>
   ...
   <a href="index" class="btn btn-xl btn-outline-light">돌아가기</a> <a href="/" class="btn btn-xl btn-outline-light">홈으로</a>
   </div>
</body>
</html>
